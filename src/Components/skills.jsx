        ...
        <div class="profile-skills">
            <div>
                ...
                <ul class="skills skills1">
                    ...
                    <li class="sk-ani"><span>Graphics</span></li>
                    <li class="more">
            ...
            <ul class="skills skills2">
                <li class="sk-gim"><span>Vs Code</span></li>
                <li class="sk-ado"><span>Adobe&nbsp;CC</span></li>
                <li class="sk-not"><span>Notepad++</span></li>
                <li class="sk-tri"><span>Photoshop</span></li>
            ...
            <ul class="skills skills3">
                ...
                <li class="sk-php"><span>React</span></li>
                <li class="sk-sql"><span>Node</span></li>
                <li class="more">
